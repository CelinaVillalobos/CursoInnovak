---
title: "Bioensayo Nebiol y extractos M1-M6"
...
Longitud <- read.csv("~/RStudio/CursoInnovak/Agronomia/Materiales/Longitud nebiol M1-M6.csv")

Laterales <- read.csv("~/RStudio/CursoInnovak/Agronomia/Materiales/Laterales nebiol M1-M6.csv")

# Archivo para los grarficos separados 
Bioensayo <- read.csv("~/RStudio/CursoInnovak/Agronomia/Materiales/Bioensayo M1-M6_long_lateral.csv")
...
```
```{r}
# Ambos lotes en un mismo grafico para la varialbe de la lonitud de raiz: 
Prom <- Longitud %>%
...
- Hugo quiere que le agreguemos leyenda de que es cada tratamiento.
-
